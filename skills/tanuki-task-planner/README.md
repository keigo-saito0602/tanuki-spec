...
`traceability.yaml` を入力に、実装タスク・依存関係・完了条件・検証方法を作成するスキルです。

```bash
../../tanuki-spec-all/.venv/bin/python evaluation/task_plan_gate.py path/to/task-plan.yaml --traceability path/to/traceability.yaml
