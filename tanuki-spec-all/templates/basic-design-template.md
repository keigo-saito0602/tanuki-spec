...
| `bd-biz-system` | 業務体系・業務処理概要 | 仕様変更に強い業務分割・処理形態を明確化する | 設計品質観点(機能性) | 機能性 |
...
| `bd-processing` | 処理方式の選定・確認 | 処理方式を選定し非機能要件と整合させる | 設計観点 S13 | 性能 |
...
| `bd-cross-cutting` | 横断的関心事（セキュリティ・プライバシー・可観測性） | 機能ごとに見落としやすい横断要件を設計方針として明示する | 設計品質観点(Google: cross-cutting concerns) | セキュリティ、運用性、信頼性 |
