...
- **記入ガイド**: 実現案の比較、採用理由、未解決リスクを記録し、後続の判断を再現可能にする
- **出典**: 設計品質観点(Google: alternatives/risk) ／ **品質観点**: 保守性、信頼性、ドキュメンテーション
<!-- 記入例: - 結論: <決めた内容・数値・条件>\n- 根拠: [入力] ユーザーストーリー「<該当箇所>」 -->
...
- **記入ガイド**: 機能ごとに見落としやすい横断要件を設計方針として明示する
- **出典**: 設計品質観点(Google: cross-cutting concerns) ／ **品質観点**: セキュリティ、運用性、信頼性
<!-- 記入例: - 結論: <決めた内容・数値・条件>\n- 根拠: [入力] ユーザーストーリー「<該当箇所>」 -->
...
- **記入ガイド**: 非機能方針をトレードオフを含めて具体化し、運用後の品質劣化を防ぐ
- **出典**: 設計品質観点(Microsoft: Well-Architected) ／ **品質観点**: 信頼性、セキュリティ、運用性、性能
<!-- 記入例: - 結論: <決めた内容・数値・条件>\n- 根拠: [入力] ユーザーストーリー「<該当箇所>」 -->
<!-- FILL:START bd-waf -->
（未記入）
<!-- FILL:END bd-waf -->
