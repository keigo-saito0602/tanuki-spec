...
- **記入ガイド**: 「真の目的」を明確化し、以後の要件取捨選択・優先順位判断の拠り所にする
- **出典**: 要件定義観点 S21/S107 ／ **品質観点**: 機能性
...
- **記入ガイド**: システム化範囲を確定し対象漏れ・認識齟齬を防ぐ
- **出典**: 要件品質観点(機能性)／要件定義観点 S21 ／ **品質観点**: 機能性
<!-- 記入例: - 結論: <決めた内容・数値・条件>\n- 根拠: [入力] ユーザーストーリー「<該当箇所>」 -->
...
- **記入ガイド**: 所掌の違いによる要求スコープ・実現レベルの食い違いを防ぐ
- **出典**: 要件定義観点 S22/S56/S107 ／ **品質観点**: 機能性
<!-- 記入例: - 結論: <決めた内容・数値・条件>\n- 根拠: [入力] ユーザーストーリー「<該当箇所>」 -->
...
- **記入ガイド**: 現状と新業務の変化・影響を可視化し見直し漏れを防ぐ
- **出典**: 要件定義観点 S23-25 ／ **品質観点**: 機能性
<!-- 記入例: - 結論: <決めた内容・数値・条件>\n- 根拠: [入力] ユーザーストーリー「<該当箇所>」 -->
...
- **記入ガイド**: 利用者視点の利用文脈（Who/What/Why）を起点として明確化する
- **出典**: 叩き台／cc-sdd(spec-requirements) ／ **品質観点**: 機能性、操作性
<!-- 記入例: - 結論: <決めた内容・数値・条件>\n- 根拠: [入力] ユーザーストーリー「<該当箇所>」 -->
...
- **記入ガイド**: Priority/Who/When&条件/What&量/Where/Why/How/HowMuchの見落としを防ぐ
- **出典**: 要件定義観点 S111 ／ **品質観点**: 機能性
<!-- 記入例: - 結論: <決めた内容・数値・条件>\n- 根拠: [入力] ユーザーストーリー「<該当箇所>」 -->
...
- **記入ガイド**: 要件をグループ化し優先度判断をぶれさせない
- **出典**: 要件定義観点 S112 ／ **品質観点**: 機能性
<!-- 記入例: - 結論: <決めた内容・数値・条件>\n- 根拠: [入力] ユーザーストーリー「<該当箇所>」 -->
...
- **記入ガイド**: データ構造・流れを独立の柱で整理しDB設計との手戻りを防ぐ
- **出典**: 要件品質観点(機能性)／要件定義観点 S24/S36 ／ **品質観点**: 機能性
<!-- 記入例: - 結論: <決めた内容・数値・条件>\n- 根拠: [入力] ユーザーストーリー「<該当箇所>」 -->
...
- **記入ガイド**: JIS/業界標準・既存コード表との整合を事前確認する
- **出典**: 要件品質観点(機能性) ／ **品質観点**: 機能性
<!-- 記入例: - 結論: <決めた内容・数値・条件>\n- 根拠: [入力] ユーザーストーリー「<該当箇所>」 -->
<!-- FILL:START req-code -->
（未記入）
<!-- FILL:END req-code -->
...
- **記入ガイド**: 入出力様式・操作方法を統一し操作ミスを抑制する
- **出典**: 要件品質観点(操作性) ／ **品質観点**: 操作性
<!-- 記入例: - 結論: <決めた内容・数値・条件>\n- 根拠: [入力] ユーザーストーリー「<該当箇所>」 -->
<!-- FILL:START req-io -->
（未記入）
<!-- FILL:END req-io -->
...
- **記入ガイド**: 授受方式・タイミング・形式を明確化し結合試験の手戻りを防ぐ
- **出典**: 要件品質観点(機能性)／要件定義観点 S51 ／ **品質観点**: 機能性
<!-- 記入例: - 結論: <決めた内容・数値・条件>\n- 根拠: [入力] ユーザーストーリー「<該当箇所>」 -->
...
- **記入ガイド**: 機能要件と方式を整合させ開発規模・予算の見誤りを防ぐ
- **出典**: 要件定義観点 S26-27/S33 ／ **品質観点**: 性能、拡張性
<!-- 記入例: - 結論: <決めた内容・数値・条件>\n- 根拠: [入力] ユーザーストーリー「<該当箇所>」 -->
...
- **記入ガイド**: 過度なカスタマイズによる保守困難化・サポート切れを回避する
- **適用条件**: 業務パッケージ/SaaSを採用する場合
- **出典**: 要件定義観点 S28-30 ／ **品質観点**: 機能性、保守性
<!-- 記入例: - 結論: <決めた内容・数値・条件>\n- 根拠: [入力] ユーザーストーリー「<該当箇所>」 -->
...
- **記入ガイド**: 一括りの「非機能要件」での抜け漏れを防ぐ（詳細は non_functional を展開）
- **出典**: 要件品質観点(各シート)／要件定義観点 S73-83／非機能観点 ／ **品質観点**: 信頼性、性能、拡張性、運用性、保守性、移行性、セキュリティ、システム環境エコロジー
<!-- 記入例: - 結論: <決めた内容・数値・条件>\n- 根拠: [入力] ユーザーストーリー「<該当箇所>」 -->
...
- **記入ガイド**: 基盤系だけでなく業務運用側の非機能も明文化する
- **出典**: 要件定義観点 S81-83 ／ **品質観点**: 運用性、信頼性、移行性
<!-- 記入例: - 結論: <決めた内容・数値・条件>\n- 根拠: [入力] ユーザーストーリー「<該当箇所>」 -->
...
- **記入ガイド**: 完成の合格判定基準を明確にする。受け入れ条件はEARS 5パターン（常時/イベント駆動/状態駆動/異常系/オプション）で書き、具体シナリオは受入試験(AC)のGherkinへ落とす（references/ears-gherkin-guidelines.md）
- **出典**: 叩き台／cc-sdd(EARS受け入れ基準) ／ **品質観点**: 機能性
<!-- 記入例: - 結論: <決めた内容・数値・条件>\n- 根拠: [入力] ユーザーストーリー「<該当箇所>」 -->
...
- **記入ガイド**: 本番移行可否を業務・システム・試験網羅性・品質・体制から段階判定する
- **出典**: 要件定義観点 S109-110 ／ **品質観点**: 移行性、信頼性
<!-- 記入例: - 結論: <決めた内容・数値・条件>\n- 根拠: [入力] ユーザーストーリー「<該当箇所>」 -->
...
- **記入ガイド**: 要件からテスト項目が導出できることを事前確認しV字の試験漏れを防ぐ
- **出典**: 要件品質観点(移行性)／要件定義観点 S116 ／ **品質観点**: 信頼性
<!-- 記入例: - 結論: <決めた内容・数値・条件>\n- 根拠: [入力] ユーザーストーリー「<該当箇所>」 -->
...
- **記入ガイド**: 移行方式と失敗時の切り戻し手順を事前定義しトラブルを防ぐ
- **出典**: 要件品質観点(移行性)／要件定義観点 S51 ／ **品質観点**: 移行性
<!-- 記入例: - 結論: <決めた内容・数値・条件>\n- 根拠: [入力] ユーザーストーリー「<該当箇所>」 -->
...
- **記入ガイド**: 平常時・故障時・保全時の運用分担を明確化する
- **出典**: 要件品質観点(運用性/保守性) ／ **品質観点**: 運用性、保守性
<!-- 記入例: - 結論: <決めた内容・数値・条件>\n- 根拠: [入力] ユーザーストーリー「<該当箇所>」 -->
...
- **記入ガイド**: システム化効果を定量評価できる指標を要件段階で定義する
- **出典**: 要件品質観点(機能性/環境)／要件定義観点 S102 ／ **品質観点**: システム環境エコロジー、機能性
<!-- 記入例: - 結論: <決めた内容・数値・条件>\n- 根拠: [入力] ユーザーストーリー「<該当箇所>」 -->
<!-- FILL:START req-kpi -->
（未記入）
<!-- FILL:END req-kpi -->
...
- **記入ガイド**: 論点の蒸し返し時に判断根拠を遡れるようにし手戻りを防ぐ
- **出典**: 要件定義観点 S5/S111 ／ **品質観点**: ドキュメンテーション
<!-- 記入例: - 結論: <決めた内容・数値・条件>\n- 根拠: [入力] ユーザーストーリー「<該当箇所>」 -->
...
- **記入ガイド**: 必要な業務知識・技術知識を持つ人材確保を確認する
- **出典**: 要件定義観点 S22/S108 ／ **品質観点**: 機能性
<!-- 記入例: - 結論: <決めた内容・数値・条件>\n- 根拠: [入力] ユーザーストーリー「<該当箇所>」 -->
<!-- FILL:START req-team -->
（未記入）
<!-- FILL:END req-team -->
...
- **記入ガイド**: 個人情報保護法・PCIDSS等への対応可否を要件段階で確認する
- **出典**: 要件品質観点(セキュリティ) ／ **品質観点**: セキュリティ
<!-- 記入例: - 結論: <決めた内容・数値・条件>\n- 根拠: [入力] ユーザーストーリー「<該当箇所>」 -->
...
- **記入ガイド**: 粒度・用語を統一し後工程・保守での解釈齟齬を防ぐ
- **出典**: 要件品質観点(ドキュメンテーション)／要件定義観点 S113-115 ／ **品質観点**: ドキュメンテーション
<!-- 記入例: - 結論: <決めた内容・数値・条件>\n- 根拠: [入力] ユーザーストーリー「<該当箇所>」 -->
